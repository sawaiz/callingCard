...
\setmainfont [ Path = ./fonts/Poiret_One/] {PoiretOne-Regular.ttf}
...
\setmainfont [ Path = ./fonts/Dawning_of_a_New_Day/] {DawningofaNewDay-Regular.ttf}
